# Work — quickstart-now/hejbro#302

What was built, measured and reversed under the decisions, one entry per PR or group (`W#`). Managed by `blackbox add work`; append-only.

<a id="w1"></a>
## W1 — extend-query-runtime — one half ships, one half is measured and does not
...
Migrated from the single-file entry `.blackbox/2026-08-30-extend-query-runtime.md`, kept verbatim at `.blackbox/302/artifacts/2026-08-30-extend-query-runtime.md`.
