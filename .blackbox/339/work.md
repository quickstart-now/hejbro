# Work — quickstart-now/hejbro#339

What was built, measured and reversed under the decisions, one entry per PR or group (`W#`). Managed by `blackbox add work`; append-only.

<a id="w1"></a>
## W1 — fix-row-keys — result rows arrive keyed by their declared keys (#339)
...
Migrated from the single-file entry `.blackbox/2026-08-27-fix-row-keys.md`, kept verbatim at `.blackbox/339/artifacts/2026-08-27-fix-row-keys.md`.
