...
| [#846](846/) | init/config paths round 2: read-side trailing separator, config ancestor order, nesting wording, dangling link on read, empty --config | open | #847 | 0 | 5 (0 pending) |
...
Owner decisions 80 · rulings 158 (interpretation 105, extension 51, stop 2) · pending extensions 13 · rejected 2
