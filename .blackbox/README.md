...
| ↳ [#501](501/) | add a real FILTER (WHERE …) aggregate constructor | open |  | 0 | 6 (1 pending) |
...
| [#815](815/) | 0.2.x: post-release commitments (2) | open | #867 #868 #871 #878 #968 #893 (via #814) #910 (via #816) #924 (via #816) #840 (via #819) #876 (via #820) #835 (via #823) #877 (via #823) #833 (via #832) #838 (via #836) #851 (via #841) #855 (via #841) #849 (via #845) #850 (via #845) #847 (via #846) #858 (via #856) #861 (via #856) #955 (via #891) #962 (via #891) #900 (via #899) #956 (via #932) | 0 | 0 (0 pending) |
...
Owner decisions 93 · rulings 245 (interpretation 164, extension 79, stop 2) · pending extensions 41 · rejected 2
