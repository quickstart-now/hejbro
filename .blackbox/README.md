...
| [#412](412/) | 0.2.x: post-release commitments | open | #715 #808 | 9 | 26 (0 pending) |
...
| ↳ [#807](807/) | ci: a dev → main PR runs every check twice (push + pull_request on the same sha) | closed | #808 | 1 | 1 (0 pending) |
| ↳ [#809](809/) | ci: verify on a pr waits for the owner's environment approval | open |  | 2 | 2 (0 pending) |
...
Owner decisions 70 · rulings 100 (interpretation 60, extension 38, stop 2) · pending extensions 0 · rejected 2
