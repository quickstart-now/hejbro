...
| ↳ [#701](701/) | array order in kind snapshots can produce a semantically empty alter | closed | #858 | 0 | 5 (0 pending) |
| ↳ [#740](740/) | Vendored contract column order follows JS key order, not the snapshot's physical order | closed | #858 | 0 | 2 (0 pending) |
...
| ↳ [#749](749/) | a projected .returning() under returns setof <table> must cover the table's column list | closed | #858 | 0 | 2 (1 pending) |
