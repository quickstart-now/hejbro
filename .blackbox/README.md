...
| ↳ [#701](701/) | array order in kind snapshots can produce a semantically empty alter | open |  | 0 | 2 (0 pending) |
...
| ↳ [#749](749/) | a projected .returning() under returns setof <table> must cover the table's column list | open |  | 0 | 1 (1 pending) |
...
Owner decisions 80 · rulings 145 (interpretation 94, extension 49, stop 2) · pending extensions 11 · rejected 2
