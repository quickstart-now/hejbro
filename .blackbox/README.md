...
| ↳ [#501](501/) | add a real FILTER (WHERE …) aggregate constructor | closed | #963 | 0 | 8 (1 pending) |
...
| ↳ [#931](931/) | core: an aggregate call inside a filter() condition is accepted at build time and refused by Postgres (42803) | open | #963 | 0 | 0 (0 pending) |
