...
| [#412](412/) | 0.2.x: post-release commitments | open | #715 | 9 | 26 (0 pending) |
...
| ↳ [#807](807/) | ci: a dev → main PR runs every check twice (push + pull_request on the same sha) | open |  | 1 | 1 (0 pending) |
