...
| ↳ [#668](668/) | generate: warn when adopting an existing table will create sequences, RLS or policies that may already exist | closed | #1019 #1043 | 0 | 0 (0 pending) |
| ↳ [#671](671/) | existing: adoption never creates the adopted table's declared indexes, checks, FKs or primary key | closed | #1019 #1043 | 0 | 12 (5 pending) |
...
| ↳ [#694](694/) | handover then adoption fails to apply: sequence already exists | closed | #1019 #1043 | 0 | 0 (0 pending) |
...
| [#815](815/) | 0.2.x: post-release commitments (2) | open | #867 #868 #871 #878 #968 #976 #979 #980 #988 #991 #992 #999 #1005 #1010 #1011 #1014 #1019 #1026 #1027 #1028 #1041 #1043 #893 (via #814) #910 (via #816) #924 (via #816) #840 (via #819) #876 (via #820) #835 (via #823) #877 (via #823) #833 (via #832) #838 (via #836) #851 (via #841) #855 (via #841) #849 (via #845) #850 (via #845) #847 (via #846) #858 (via #856) #861 (via #856) #955 (via #891) #962 (via #891) #900 (via #899) #963 (via #931) #956 (via #932) | 0 | 1 (1 pending) |
...
| [#995](995/) | 0.2.x: post-release commitments (3) | open | #999 #1005 #1010 #1011 #1014 #1019 #1026 #1027 #1028 #1041 #1043 | 0 | 0 (0 pending) |
...
| ↳ [#1001](1001/) | generate: adoption's banner notes describe column diffs that emit no statements | open | #1019 #1043 | 0 | 0 (0 pending) |
...
| ↳ [#1009](1009/) | adoption: re-adopting a table a handover left in the database re-creates its policies and constraints (42710 / 42P16) | open | #1019 #1043 | 0 | 0 (0 pending) |
...
| ↳ [#1015](1015/) | adoption: a column-level unique() is neither created nor named by adoption-creates | open | #1019 #1043 | 0 | 0 (0 pending) |
...
| ↳ [#1037](1037/) | migrate: an adoption migration whose objects the database already holds has no official path to be registered instead of run | open | #1043 | 0 | 0 (0 pending) |
...
| ↳ [#1042](1042/) | check: a primary key whose derived name another constraint already holds is reported as missing, not as a name collision | open | #1043 | 0 | 0 (0 pending) |
