...
| ↳ [#701](701/) | array order in kind snapshots can produce a semantically empty alter | open |  | 0 | 1 (0 pending) |
| ↳ [#740](740/) | Vendored contract column order follows JS key order, not the snapshot's physical order | open |  | 0 | 0 (0 pending) |
...
| ↳ [#749](749/) | a projected .returning() under returns setof <table> must cover the table's column list | open |  | 0 | 0 (0 pending) |
...
Owner decisions 80 · rulings 142 (interpretation 92, extension 48, stop 2) · pending extensions 10 · rejected 2
