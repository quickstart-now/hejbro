...
| ↳ [#741](741/) | `hejbro init --config <path>` is ignored and scaffolds a competing project | open |  | 0 | 2 (0 pending) |
| ↳ [#743](743/) | `init` and `generate` name the same file two different ways | open |  | 0 | 1 (1 pending) |
...
Owner decisions 80 · rulings 124 (interpretation 76, extension 46, stop 2) · pending extensions 8 · rejected 2
