...
| ↳ [#678](678/) | infer: role names from policies, not only from grants | closed | #1026 #1049 #1060 #1066 #1068 | 0 | 0 (0 pending) |
...
| [#815](815/) | 0.2.x: post-release commitments (2) | open | #867 #868 #871 #878 #968 #976 #979 #980 #988 #991 #992 #999 #1005 #1010 #1011 #1014 #1019 #1026 #1027 #1028 #1041 #1043 #1046 #1049 #1060 #1062 #1066 #1068 #893 (via #814) #910 (via #816) #924 (via #816) #840 (via #819) #876 (via #820) #835 (via #823) #877 (via #823) #833 (via #832) #838 (via #836) #851 (via #841) #855 (via #841) #849 (via #845) #850 (via #845) #847 (via #846) #858 (via #856) #861 (via #856) #955 (via #891) #962 (via #891) #900 (via #899) #963 (via #931) #956 (via #932) | 0 | 1 (1 pending) |
...
| ↳ [#872](872/) | import: a non-default primary-key constraint name is dropped with no loss-report line | closed | #878 #1026 #1049 #1060 #1066 #1068 | 0 | 1 (1 pending) |
| ↳ [#873](873/) | import: a foreign key referencing an omitted column makes the starter declaration fail to load | closed | #878 #1026 #1049 #1060 #1066 #1068 | 0 | 0 (0 pending) |
| ↳ [#874](874/) | loss report: sortedBy uses localeCompare, so import/pull output order depends on the locale | closed | #878 #1026 #1049 #1060 #1066 #1068 | 0 | 0 (0 pending) |
...
| [#981](981/) | cli integration suites drifted from examples/postgres after #900: check-live 6.3 and declare-emit-roundtrip 2.2 fail on dev | open | #1005 #1049 #1068 | 0 | 0 (0 pending) |
...
| [#995](995/) | 0.2.x: post-release commitments (3) | open | #999 #1005 #1010 #1011 #1014 #1019 #1026 #1027 #1028 #1041 #1043 #1046 #1049 #1060 #1062 #1066 #1068 | 0 | 0 (0 pending) |
...
| ↳ [#1006](1006/) | check: the database-only inventory does not name an enum type the declarations do not carry | open | #1026 #1068 | 0 | 0 (0 pending) |
...
| ↳ [#1016](1016/) | import: a cross-schema handle's columns are emitted with arbitrary types (text() for an int column) | open | #1026 #1049 #1060 #1068 | 0 | 0 (0 pending) |
| ↳ [#1017](1017/) | baseline: a primary key whose derived name is already taken by an index on the same table emits the name twice | open | #1026 #1068 | 0 | 0 (0 pending) |
| ↳ [#1018](1018/) | loss report ordering: no server-collation axis and no unit test for compareCodeUnits | open | #1026 #1068 | 0 | 0 (0 pending) |
| ↳ [#1020](1020/) | import: the primary-key name collision check does not see composite types or foreign tables holding the derived name | open | #1026 #1068 | 0 | 0 (0 pending) |
...
| ↳ [#1022](1022/) | import: a generated stored column loses its expression, so the starter fails the next check | closed | #1026 #1049 #1068 | 0 | 0 (0 pending) |
| ↳ [#1023](1023/) | import: an index key's COLLATE clause is dropped silently | open | #1026 #1068 | 0 | 0 (0 pending) |
| ↳ [#1024](1024/) | loss report: the pull lines for index, check, unique and primary key say 'cannot be carried in the contract' where the loss is in the vendored schema | open | #1068 | 0 | 0 (0 pending) |
...
| ↳ [#1032](1032/) | import/pull: column-level and sequence-level grants contribute no role name to the reading | open | #1049 #1068 | 0 | 0 (0 pending) |
| ↳ [#1033](1033/) | import: an index's INCLUDE columns are dropped silently, and the omitted-index line calls an INCLUDE list an expression | open | #1049 #1060 #1068 | 0 | 0 (0 pending) |
| ↳ [#1034](1034/) | import: partitioning, inheritance, UNLOGGED, comments and RLS enablement are dropped without a Not inferred line | open | #1049 #1060 #1068 | 0 | 0 (0 pending) |
| ↳ [#1037](1037/) | migrate: an adoption migration whose objects the database already holds has no official path to be registered instead of run | open | #1043 #1046 #1060 #1068 | 0 | 0 (0 pending) |
...
| ↳ [#1039](1039/) | pull: --schema repeated with the same name is accepted and recorded twice in the lock and the contract metadata | open | #1041 #1060 #1066 #1068 | 0 | 0 (0 pending) |
...
| ↳ [#1061](1061/) | test: check:crap fails under machine load through vendor-check's 10s hooks, and reads as red tests | open | #1060 #1068 | 0 | 0 (0 pending) |
