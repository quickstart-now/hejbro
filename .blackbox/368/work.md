# Work — quickstart-now/hejbro#368

What was built, measured and reversed under the decisions, one entry per PR or group (`W#`). Managed by `blackbox add work`; append-only.

<a id="w1"></a>
## W1 — generated-columns group 1 — the surface, and a probe that caught a gap before review
...
Migrated from the single-file entry `.blackbox/2026-08-28-generated-columns-group1.md`, kept verbatim at `.blackbox/368/artifacts/2026-08-28-generated-columns-group1.md`.
