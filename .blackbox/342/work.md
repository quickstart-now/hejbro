# Work — quickstart-now/hejbro#342

What was built, measured and reversed under the decisions, one entry per PR or group (`W#`). Managed by `blackbox add work`; append-only.

<a id="w1"></a>
## W1 — fix-array-roundtrip — the shared inverse property the parallel groups deferred (#342)
...
Migrated from the single-file entry `.blackbox/2026-08-27-fix-array-roundtrip.md`, kept verbatim at `.blackbox/342/artifacts/2026-08-27-fix-array-roundtrip.md`.
