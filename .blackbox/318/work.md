# Work — quickstart-now/hejbro#318

What was built, measured and reversed under the decisions, one entry per PR or group (`W#`). Managed by `blackbox add work`; append-only.

<a id="w1"></a>
## W1 — add-context-provider — the generic context provider (#318)
...
Migrated from the single-file entry `.blackbox/2026-08-31-add-context-provider.md`, kept verbatim at `.blackbox/318/artifacts/2026-08-31-add-context-provider.md`.
