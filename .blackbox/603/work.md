# Work — quickstart-now/hejbro#603

What was built, measured and reversed under the decisions, one entry per PR or group (`W#`). Managed by `blackbox add work`; append-only.

<a id="w1"></a>
## W1 — add-apply-engine — hejbro owns applying a migration chain (#603)
...
Migrated from the single-file entry `.blackbox/2026-09-02-add-apply-engine.md`, kept verbatim at `.blackbox/603/artifacts/2026-09-02-add-apply-engine.md`.
