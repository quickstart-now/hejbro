# Work — quickstart-now/hejbro#470

What was built, measured and reversed under the decisions, one entry per PR or group (`W#`). Managed by `blackbox add work`; append-only.

<a id="w1"></a>
## W1 — harden-query-surface — five query/declaration-surface hardening defects
...
Migrated from the single-file entry `.blackbox/2026-08-29-harden-query-surface.md`, kept verbatim at `.blackbox/470/artifacts/2026-08-29-harden-query-surface.md`.
