# Work — quickstart-now/hejbro#300

What was built, measured and reversed under the decisions, one entry per PR or group (`W#`). Managed by `blackbox add work`; append-only.

<a id="w1"></a>
## W1 — 2026-08-29 — `@hejbro/neon`, the second provider preset
...
Migrated from the single-file entry `.blackbox/2026-08-29-add-neon-preset.md`, kept verbatim at `.blackbox/300/artifacts/2026-08-29-add-neon-preset.md`.
