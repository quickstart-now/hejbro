# Work — quickstart-now/hejbro#388

What was built, measured and reversed under the decisions, one entry per PR or group (`W#`). Managed by `blackbox add work`; append-only.

<a id="w1"></a>
## W1 — generated-columns group 4 — the real server signs off on group 2's ordering
...
Migrated from the single-file entry `.blackbox/2026-08-28-generated-columns-group4.md`, kept verbatim at `.blackbox/388/artifacts/2026-08-28-generated-columns-group4.md`.
