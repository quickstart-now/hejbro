...
import { ddland, posts, publishedPosts } from "./declarations";

// Step 0: from empty — posts and its published_posts view.

const fromEmpty: ReadonlyArray<HejbroInput> = [ddland, posts, publishedPosts];
...
const viewRemoved: ReadonlyArray<HejbroInput> = [ddland, posts];
