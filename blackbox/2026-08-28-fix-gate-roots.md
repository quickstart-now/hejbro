Refs:
- scripts/check-next-marker.mjs @ blob c8bddc39f64c77141191154cb90dc60dc0faac4f
- scripts/check-diagnostic-xref.mjs @ blob bae29e4491cb0e8f25a3665df89ac96a27527b9d

# fix-gate-roots — the diagnostic gates learn to see query and pg (#361)
...
The owner approved the proposed order — #361 first, then the #308
proposal — with "proceed". No further owner decisions arose: the
measured compliance state made the message-text half of the issue's fix
direction moot (below).
