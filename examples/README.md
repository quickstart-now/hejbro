...
| Example | What it is |
|---|---|
| `postgres` | A generic team-workspace schema on plain Postgres — core only, no seed data. Tables, CHECK constraints, partial and ordered indexes, a self-referencing FK, RLS, a trigger, a view, grants, with a committed four-step migration history and a local Docker round-trip. |
