 ...
 * roles, a before-trigger, a view, and schema-level grants. Eight steps
 * (`step-1` … `step-8`) evolve it; step 7 added `task_labels` (see the
 * #121 grant-sync note below, unchanged since). This is step 8 — non-B-tree
