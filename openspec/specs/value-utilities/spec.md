# value-utilities Specification

## Purpose

Defines the exported runtime helpers over declared-type values. First
populated by add-array-ergonomics (assertNoNulls); grows as later
changes add helpers.
