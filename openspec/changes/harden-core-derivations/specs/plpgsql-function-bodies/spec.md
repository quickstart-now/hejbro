...
- a keyword Postgres fully reserves, or plpgsql reserves for its own
  statements, which cannot stand unquoted in a body at all;
...
- **WHEN** a function declares an argument or names a row or loop
