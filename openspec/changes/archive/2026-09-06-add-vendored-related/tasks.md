...
- [x] 1.1 (~9m) **[design]** The contract emits `Relations`. Settles the
...
- [x] 1.2 (~10m) `.related()` on the name-keyed chain. Red: the
...
- [x] 1.3 (~7m) The two-repository witness. Red:
...
- [x] 1.4 (~7m) The references, the guide, the changeset. Red: the
