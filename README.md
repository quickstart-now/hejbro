...
<!-- crap-badge:start -->
[![CRAP ≤ 5 · 0 / 1573](https://img.shields.io/badge/CRAP%20%E2%89%A4%205-0%20%2F%201573-brightgreen)](#status)
<!-- crap-badge:end -->
<!-- tasktime-badges:start -->
[![tasks · 502 done](https://img.shields.io/badge/tasks-502%20done-blue)](openspec/task-times.csv)
[![avg task · 12m](https://img.shields.io/badge/avg%20task-12m-blue)](openspec/task-times.csv)
[![estimate · 1.14x](https://img.shields.io/badge/estimate-1.14x-blue)](openspec/task-times.csv)
...
<!-- crap:start -->
**Code quality gate:** every named function in `@hejbro/core`, `@hejbro/neon`, `@hejbro/nile`, `@hejbro/pg`, `@hejbro/query`, `@hejbro/supabase` must score **CRAP ≤ 5** (CRAP = CC² × (1 − coverage)³ + CC; gated in CI). Current: **0 of 1573 functions** over the threshold, highest score 5.00 — measured at `b675895e` (2026-09-01).
<!-- crap:end -->
