...
<!-- crap-badge:start -->
[![CRAP ≤ 5 · 0 / 1454](https://img.shields.io/badge/CRAP%20%E2%89%A4%205-0%20%2F%201454-brightgreen)](#status)
<!-- crap-badge:end -->
<!-- tasktime-badges:start -->
[![tasks · 286 done](https://img.shields.io/badge/tasks-286%20done-blue)](openspec/task-times.csv)
[![avg task · 14m](https://img.shields.io/badge/avg%20task-14m-blue)](openspec/task-times.csv)
[![estimate · 1.70x](https://img.shields.io/badge/estimate-1.70x-blue)](openspec/task-times.csv)
...
<!-- crap:start -->
**Code quality gate:** every named function in `@hejbro/core`, `@hejbro/supabase`, `@hejbro/query`, `@hejbro/pg`, `@hejbro/neon` must score **CRAP ≤ 5** (CRAP = CC² × (1 − coverage)³ + CC; gated in CI). Current: **0 of 1454 functions** over the threshold, highest score 5.00 — measured at `2fa2d32` (2026-08-29).
<!-- crap:end -->
