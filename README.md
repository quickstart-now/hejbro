...
<!-- crap-badge:start -->
[![CRAP ≤ 5 · 0 / 978](https://img.shields.io/badge/CRAP%20%E2%89%A4%205-0%20%2F%20978-brightgreen)](#status)
<!-- crap-badge:end -->
...
<!-- crap:start -->
**Code quality gate:** every named function in `@hejbro/core` and `@hejbro/supabase` must score **CRAP ≤ 5** (CRAP = CC² × (1 − coverage)³ + CC; gated in CI). Current: **0 of 978 functions** over the threshold, highest score 5.00 — measured at `83a8a15` (2026-08-26).
<!-- crap:end -->
