...
<!-- crap-badge:start -->
[![CRAP ≤ 5 · 0 / 1512](https://img.shields.io/badge/CRAP%20%E2%89%A4%205-0%20%2F%201512-brightgreen)](#status)
<!-- crap-badge:end -->
<!-- tasktime-badges:start -->
[![tasks · 447 done](https://img.shields.io/badge/tasks-447%20done-blue)](openspec/task-times.csv)
[![avg task · 12m](https://img.shields.io/badge/avg%20task-12m-blue)](openspec/task-times.csv)
[![estimate · 1.35x](https://img.shields.io/badge/estimate-1.35x-blue)](openspec/task-times.csv)
...
<!-- crap:start -->
**Code quality gate:** every named function in `@hejbro/core`, `@hejbro/neon`, `@hejbro/nile`, `@hejbro/pg`, `@hejbro/query`, `@hejbro/supabase` must score **CRAP ≤ 5** (CRAP = CC² × (1 − coverage)³ + CC; gated in CI). Current: **0 of 1512 functions** over the threshold, highest score 5.00 — measured at `c889b2f0` (2026-08-31).
<!-- crap:end -->
