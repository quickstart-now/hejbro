...
[![tasks · 682 done](https://img.shields.io/badge/tasks-682%20done-blue)](openspec/task-times.csv)
[![avg task · 13m](https://img.shields.io/badge/avg%20task-13m-blue)](openspec/task-times.csv)
[![estimate · 1.33x](https://img.shields.io/badge/estimate-1.33x-blue)](openspec/task-times.csv)
...
<!-- crap:start -->
**Code quality gate:** every named function in `@hejbro/core`, `@hejbro/neon`, `@hejbro/nile`, `@hejbro/pg`, `@hejbro/query`, `@hejbro/supabase` must score **CRAP ≤ 5** (CRAP = CC² × (1 − coverage)³ + CC; gated in CI). Current: **0 of 1659 functions** over the threshold, highest score 5.00 — measured at `d9a89cad` (2026-09-04).
<!-- crap:end -->
