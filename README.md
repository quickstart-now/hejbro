...
<!-- crap-badge:start -->
[![CRAP ≤ 5 · 0 / 1350](https://img.shields.io/badge/CRAP%20%E2%89%A4%205-0%20%2F%201350-brightgreen)](#status)
<!-- crap-badge:end -->
<!-- tasktime-badges:start -->
[![tasks · 166 done](https://img.shields.io/badge/tasks-166%20done-blue)](openspec/task-times.csv)
[![avg task · 17m](https://img.shields.io/badge/avg%20task-17m-blue)](openspec/task-times.csv)
[![estimate · 1.95x](https://img.shields.io/badge/estimate-1.95x-blue)](openspec/task-times.csv)
...
<!-- crap:start -->
**Code quality gate:** every named function in `@hejbro/core`, `@hejbro/supabase`, `@hejbro/query`, `@hejbro/pg` must score **CRAP ≤ 5** (CRAP = CC² × (1 − coverage)³ + CC; gated in CI). Current: **0 of 1350 functions** over the threshold, highest score 5.00 — measured at `3a7f645` (2026-08-28).
<!-- crap:end -->
