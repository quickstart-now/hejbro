...
[![tasks · 729 done](https://img.shields.io/badge/tasks-729%20done-blue)](openspec/task-times.csv)
...
<!-- crap:start -->
**Code quality gate:** every named function in `@hejbro/core`, `@hejbro/neon`, `@hejbro/nile`, `@hejbro/pg`, `@hejbro/query`, `@hejbro/supabase` must score **CRAP ≤ 5** (CRAP = CC² × (1 − coverage)³ + CC; gated in CI). Current: **0 of 1675 functions** over the threshold, highest score 5.00 — measured at `ec6a02e0` (2026-09-05).
<!-- crap:end -->
