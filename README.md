...
<!-- crap-badge:start -->
[![CRAP ≤ 5 · 0 / 1276](https://img.shields.io/badge/CRAP%20%E2%89%A4%205-0%20%2F%201276-brightgreen)](#status)
<!-- crap-badge:end -->
...
<!-- crap:start -->
**Code quality gate:** every named function in `@hejbro/core`, `@hejbro/supabase`, `@hejbro/query`, `@hejbro/pg` must score **CRAP ≤ 5** (CRAP = CC² × (1 − coverage)³ + CC; gated in CI). Current: **0 of 1276 functions** over the threshold, highest score 5.00 — measured at `cbe7b61` (2026-08-28).
<!-- crap:end -->
